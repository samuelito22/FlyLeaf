...
import { EditProfileHeader, KeyboardAvoidingViewWrapper, SafeContainer, TextField } from '../../components';
...
const EditJobTitleScreen = () => {
    ...
    const jobTitle = useSelector((state: TYPES.AppState) => state.editUserReducer.jobTitle);

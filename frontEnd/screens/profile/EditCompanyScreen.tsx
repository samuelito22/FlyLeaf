...
import { EditProfileHeader, KeyboardAvoidingViewWrapper, SafeContainer } from '../../components';
...
const EditCompanyScreen = () => {
    ...
    const company = useSelector((state: TYPES.AppState) => state.editUserReducer.company);
